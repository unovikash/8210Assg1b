# Generated by Django 2.0.5 on 2018-09-15 15:37
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('customer_name', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='products', to='crm.Customer')),
            ],
        ),
        migrations.CreateModel(
            name='Service',
            fields=[
                ...
                ('created_date', models.DateTimeField(default=django.utils.timezone.now)),
                ('updated_date', models.DateTimeField(auto_now_add=True)),
                ('customer_name', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='services', to='crm.Customer')),
            ],
        ),
    ]
